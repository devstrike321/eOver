...
module.exports = {
    ...
    DELETE_OVERLAY_SETTING:() => {
        ...
        mutation deleteOverlay($id:ID!) {
            deleteOverlay(id:$id)
            @rest(type: "Overlay", path: "shop_product_overlay/{args.id}", method: "DELETE") {
                code
                message
                success
            }
    ...
    CHANGE_OVERLAY_STATUS:() => {
        ...
        mutation changeOverlayStatus($input:changeOverlayStatusData!, $id:ID!) {
            ...
            @rest(type: "Overlay", path: "shop_product_overlay_status/{args.id}", method: "PUT") {
                code
                data
                message
                success
    ...
    UPDATE_SUBSCRIPTION_INFO_IN_DB:() => {
        ...
        mutation updateSubscription($input:subscriptionInfo!, $id:ID!) {
            ...
            @rest(type: "Subscription", path: "shop_plan/{args.id}", method: "PUT") {
                code
                data
                message
                success
