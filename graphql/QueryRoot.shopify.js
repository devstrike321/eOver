...
module.exports = {
      ...
      query getOverlays($productId: String!) {
        overlays(productId: $productId)
          @rest(
            method: "GET"
            type: "[Overlay]"
            path: "shop_product_overlays/{args.productId}"
          ) {
          code
          data
          message
  ...
  GET_SETTINGS: () => {
    return gql`
      query getSettings {
        settings
          @rest(method: "GET", type: "[Setting]", path: "shop_settings") {
          code
          data
          message
          success
      ...
      query getOverlays($shopName: String!) {
        planProdInfo(shopName: $shopName)
          @rest(
            method: "GET"
            type: "[PlanProdInfo]"
            path: "shop_overview/{args.shopName}"
          ) {
          code
          data
          message
  ...
  SYNC_SHOPIFY_PRODUCTS: () => {
    return gql`
      query getOverlays($filter: Filter!) {
