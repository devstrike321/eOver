...
const ProductList = (props) => {
  ...
  const [firstLimit, setFirstLimit] = useState(10); // this should configure under env file
  ...
  return (
    <React.Fragment>
      <Query
        query={QueryRootShopify.GET_SHOPIFY_PRODUCTS()}
        variables={{
          first: firstLimit,
          after: afterCursor,
          last: lastLimit,
              ...
              <div className="product_list">
                <ResourceList
                  ...
                  renderItem={(item, id, index) => {
                    ...
                    const media =
                      featuredImage !== "" ? (
                        <Thumbnail source={featuredImage} size="medium" />
                      ) : null;
                          ...
                          isPlanExpired
                            ? setQueryToast([
                                <Toast
                                  ...
                                  duration="1500"
                                  key="ugrade-plan-toast"
                                  content={upgradePlanText}
                                  error={true}
                                />,
                              ])
