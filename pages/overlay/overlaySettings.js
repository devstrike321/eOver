...
const OverlaySettings = (props) => {
  ...
  const [selectedTextDisplayInOptions, setTextDisplayInOptions] = useState([
    "COLLECTION",
    "PRODUCT",
    "IN_SEARCH",
  ]);
  ...
  ] = useState(["COLLECTION", "PRODUCT", "IN_SEARCH"]);
  ...
  const prodImage = props?.prodData?.product?.featuredMedia?.preview?.image
    ?.originalSrc
    ? props?.prodData?.product?.featuredMedia?.preview?.image?.originalSrc
    : "";
  ...
  const {
    ...
    refetch,
    networkStatus,
  } = useQuery(QueryRootShopify.GET_OVERLAY_INFO_BY_PRODUCT_ID(), {
    client: props.restClient,
    variables: { productId: productId, notifyOnNetworkStatusChange: true },
  });
        ...
        if (selectedTab == "0") {
          ...
          if (fontSize != "") {
            overlayDiv.style.fontSize = isProdScaleAdded
              ? (fontSize * textScaleProduct) / 100 + "px"
              : fontSize + "px";
          }
          if (opacity != "") {
          ...
          if (selectedTextAlign != "") {
            overlayDiv.style.textAlign = selectedTextAlign;
          }
          if (fontcolor != "") {
          ...
          if (topPadding != "") {
            overlayDiv.style.paddingTop = isProdScaleAdded
              ? (topPadding * textScaleProduct) / 100 + "px"
              : topPadding + "px";
          }
          if (rightPadding != "") {
            overlayDiv.style.paddingRight = isProdScaleAdded
              ? (rightPadding * textScaleProduct) / 100 + "px"
              : rightPadding + "px";
          }
          if (bottomPadding != "") {
            overlayDiv.style.paddingBottom = isProdScaleAdded
              ? (bottomPadding * textScaleProduct) / 100 + "px"
              : bottomPadding + "px";
          }
          if (leftPadding != "") {
            overlayDiv.style.paddingLeft = isProdScaleAdded
              ? (leftPadding * textScaleProduct) / 100 + "px"
              : leftPadding + "px";
          }
          ...
          if (selectedTextPosition == "TOP_LEFT") {
            overlayDiv.style.top = 0;
            overlayDiv.style.left = 0;
          } else if (selectedTextPosition == "TOP_CENTER") {
            overlayDiv.style.top = 0;
            overlayDiv.style.left = "50%";
            overlayDiv.style.transform = "translateX(-50%)" + rotate_css;
          } else if (selectedTextPosition == "TOP_RIGHT") {
            overlayDiv.style.top = 0;
            overlayDiv.style.left = "auto";
            overlayDiv.style.right = 0;
          } else if (selectedTextPosition == "MIDDLE_LEFT") {
            overlayDiv.style.top = "50%";
            overlayDiv.style.left = 0;
            overlayDiv.style.transform = "translateY(-50%)" + rotate_css;
          } else if (selectedTextPosition == "MIDDLE_CENTER") {
            overlayDiv.style.top = "50%";
            overlayDiv.style.left = "50%";
            overlayDiv.style.transform = "translate(-50%,-50%)" + rotate_css;
          } else if (selectedTextPosition == "MIDDLE_RIGHT") {
            overlayDiv.style.top = "50%";
            overlayDiv.style.left = "auto";
            overlayDiv.style.right = 0;
            overlayDiv.style.transform = "translateY(-50%)" + rotate_css;
          } else if (selectedTextPosition == "BOTTOM_LEFT") {
            overlayDiv.style.top = "auto";
            overlayDiv.style.left = 0;
            overlayDiv.style.bottom = 0;
          } else if (selectedTextPosition == "BOTTOM_CENTER") {
            overlayDiv.style.top = "auto";
            overlayDiv.style.left = "50%";
            overlayDiv.style.bottom = 0;
            overlayDiv.style.transform = "translateX(-50%)" + rotate_css;
          } else if (selectedTextPosition == "BOTTOM_RIGHT") {
            overlayDiv.style.top = "auto";
            overlayDiv.style.left = "auto";
            overlayDiv.style.bottom = 0;
            overlayDiv.style.right = 0;
      ...
      if (typeof data != "undefined" && data.overlays?.data != undefined) {
        ...
        if (document.getElementById("overlayImageBase") != undefined) {
          ...
          if (
            ...
            for (let i = 0; i < textSelectionLength; i++) {
              document
                .getElementsByClassName("overlay-text-section")[0]
                .remove();
            }
          }
          if (
          ...
          item_list.forEach((overlayRow) => {
            ...
            if (selectedTab == "0") {
              ...
              if (fontSize != "") {
                overlayDiv.style.fontSize =
                  (fontSize * scaleInProduct) / 100 + "px";
              }
              if (opacity != "") {
                overlayDiv.style.opacity = opacity;
              }
              ...
              if (topPadding != "") {
                overlayDiv.style.paddingTop =
                  (topPadding * scaleInProduct) / 100 + "px";
              }
              if (rightPadding != "") {
                overlayDiv.style.paddingRight =
                  (rightPadding * scaleInProduct) / 100 + "px";
              }
              if (bottomPadding != "") {
                overlayDiv.style.paddingBottom =
                  (bottomPadding * scaleInProduct) / 100 + "px";
              }
              if (leftPadding != "") {
                overlayDiv.style.paddingLeft =
                  (leftPadding * scaleInProduct) / 100 + "px";
              }
              ...
              overlayImg.style.position = "absolute";
              overlayImg.src = imageOverlaySrc;
              overlayImg.style.maxWidth = scaleInProduct
                ? scaleInProduct + "%"
                : "50%";
  ...
  document.onclick = function (e) {
    if (e?.target) {
      let fontColorParentNode = getParentByChild(
        e?.target,
        "font_color_connector"
      );
              ...
              <Card sectioned>
                {selectedTab == 0 ? (
                  <TextOverlaySettings
                    ...
                    stateFunc={stateFunc}
                    stateKeys={stateKeys}
                    refreshData={childListRef?.current?.refreshData}
                    setDefaultState={setDefaultOverlayData}
                  />
                ) : (
